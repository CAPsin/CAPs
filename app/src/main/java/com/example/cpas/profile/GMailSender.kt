...
class GMailSender(val context : String, val title:String) : Authenticator() {
    // 보내는 사람 이메일과 비밀번호
    val fromEmail = "a22950973@gmail.com" //개인 gmail
    val password = "aulrphcfehybearq" //개인 앱 비밀번호 입력
    ...
    fun sendEmail(toEmail: String) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            message.setText(context)                                               // 이메일 내용
